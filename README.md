...
Скачать уже собранный пакет можно по следующей <a href="https://drive.google.com/open?id=19d3aNM4_1Kx6SaX8JMIu2Rfy6zC4WnHW">ссылке</a>
...
`Preferences` показывается раздел настроек подключения к базе данных а также имена файла источника и файла сравнения
...
<image src="readme/Load/Table1.gif">
...
О успешном закрытии проекта можно понять по отсутствию имени проекта в имени окна в осном окне программы.
