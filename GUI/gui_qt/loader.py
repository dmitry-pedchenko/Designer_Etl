...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(122, 12, 311, 141))
        ...
        self.radioButton.setGeometry(QtCore.QRect(10, 30, 268, 41))
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(self.groupBox)
        self.radioButton_2.setGeometry(QtCore.QRect(10, 80, 268, 51))
        self.radioButton_2.setObjectName("radioButton_2")
        self.horizontalLayout_2.addWidget(self.groupBox)
        self.verticalLayout.addLayout(self.horizontalLayout_2)
        self.toolBox = QtWidgets.QToolBox(Form)
        self.toolBox.setGeometry(QtCore.QRect(20, 173, 961, 477))
        self.toolBox.setObjectName("toolBox")
        self.Debug = QtWidgets.QWidget()
        self.Debug.setGeometry(QtCore.QRect(0, 0, 961, 401))
        self.Debug.setObjectName("Debug")
        self.toolBox.addItem(self.Debug, "")
        self.Log = QtWidgets.QWidget()
        self.Log.setGeometry(QtCore.QRect(0, 0, 961, 401))
        self.Log.setObjectName("Log")
        self.toolBox.addItem(self.Log, "")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(Form)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(440, 10, 481, 141))
