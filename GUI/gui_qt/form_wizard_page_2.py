...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(160, 60, 281, 231))
        ...
        self.comboBox_dbSchema = QtWidgets.QComboBox(self.verticalLayoutWidget)
        ...
        self.target_table_name = QtWidgets.QComboBox(self.verticalLayoutWidget)
