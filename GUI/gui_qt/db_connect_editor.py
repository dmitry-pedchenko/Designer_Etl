...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setGeometry(QtCore.QRect(340, 20, 281, 401))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.frame)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 10, 261, 381))
        ...
        self.pushButton_Open.setGeometry(QtCore.QRect(680, 20, 112, 32))
        self.pushButton_Open.setObjectName("pushButton_Open")
        self.pushButton_Save = QtWidgets.QPushButton(Form)
        self.pushButton_Save.setGeometry(QtCore.QRect(680, 60, 112, 32))
        self.pushButton_Save.setObjectName("pushButton_Save")
        self.pushButton_SaveAs = QtWidgets.QPushButton(Form)
        self.pushButton_SaveAs.setGeometry(QtCore.QRect(680, 100, 112, 32))
